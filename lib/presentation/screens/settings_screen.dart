...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('SETTINGS', style: GoogleFonts.bangers(fontSize: 24, letterSpacing: 2)),
        centerTitle: true,
        elevation: 0,
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildToggleRow('🔊 Sound Effects', _soundEnabled, () => setState(() => _soundEnabled = !_soundEnabled)),
            _buildToggleRow('🎵 Music', _musicEnabled, () => setState(() => _musicEnabled = !_musicEnabled)),
            _buildToggleRow('📳 Haptic Feedback', _hapticEnabled, () => setState(() => _hapticEnabled = !_hapticEnabled)),
            ...
            _buildKenneyButton('SHARE', Icons.share, () {
              Share.share('Check out Battle Cows! 🐮 https://play.google.com/store/apps/details?id=com.battlecows.game');
            }),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Expanded(
                          child: KenneyButton(label: 'CANCEL', isWide: true, style: KenneyBtnStyle.neutral, onPressed: () => Navigator.pop(context)),
                        ),
  ...
  Widget _buildSectionHeader(String title) {
    return Padding(
      ...
      child: Text(title.toUpperCase(), style: GoogleFonts.bangers(fontSize: 14, color: const Color(0xFFFFD54F), letterSpacing: 2)),
    );
  }
      ...
      children: ['EASY', 'MEDIUM', 'HARD'].asMap().entries.map((entry) {
        ...
        return GestureDetector(
          ...
          child: Container(
            ...
            child: Text(entry.value, style: GoogleFonts.bangers(fontSize: 12, color: isSel ? Colors.black : Colors.white)),
          ),
        );
      }).toList(),
    );
  ...
  Widget _buildStatRow(String label, String value) {
    return Padding(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          Text(label, style: GoogleFonts.bangers(fontSize: 14, color: Colors.white70)),
          Text(value, style: GoogleFonts.bangers(fontSize: 14, color: const Color(0xFFFFD54F))),
        ],
      ),
    );
  }

  Widget _buildKenneyButton(String label, IconData icon, VoidCallback onPressed) {
    return SizedBox(
